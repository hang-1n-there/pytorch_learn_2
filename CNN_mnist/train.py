...
def main(config):
    # Set device based on user defined configuration.raise NotImplementedError('You need to specify model name.')raise NotImplementedError('You need to specify model name.')
